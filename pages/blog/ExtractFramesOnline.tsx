  ...
  return (
    <article className="max-w-3xl mx-auto py-16 px-6 font-sans">
      ...
      <div className="text-gray-300 space-y-6 leading-relaxed text-lg lg:text-xl">
        ...
        <p>
          Our tool at <Link to="/" className="text-cyan-400 hover:text-cyan-300 transition-colors font-medium underline underline-offset-4 decoration-cyan-400/30 hover:decoration-cyan-400">videotoimagesequence.online</Link> works
        ...
        <ul className="list-none pl-0 space-y-3 mt-4">
          <li className="flex items-start gap-3"><span className="text-cyan-400 mt-1">✓</span> <span><strong className="text-white">No file size limit</strong> — process movies, full game recordings</span></li>
        ...
        <ol className="list-decimal pl-6 space-y-3 mt-4 text-gray-400 marker:text-cyan-500 marker:font-bold">
          <li>Go to <Link to="/" className="text-cyan-400 hover:text-cyan-300 transition-colors">videotoimagesequence.online</Link></li>
        ...
        <p>
          ...
          With a browser-based tool like ours, you can do it for free in seconds — with no file size
          limit and complete privacy.
        </p>
