    ...
    <footer className="border-t border-gray-800 bg-gray-950 mt-16 font-sans">
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <h4 className="text-white font-semibold mb-3 text-sm">{t('footer.converterTools')}</h4>
          ...
          <div>
            <h4 className="text-white font-semibold mb-3 text-sm">{t('footer.resources')}</h4>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/#faq" className="text-gray-600 hover:text-cyan-400 transition">{t('nav.faq')}</Link></li>
            </ul>
          </div>
        </div>
