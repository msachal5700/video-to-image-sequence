...
const en = {
  ...
  "controls": {
    "frameRate": "Output Frame Rate (FPS)",
    ...
    "fpsSuffix": "Frames Per Second",
    "formatJpgDesc": "Smaller file size, recommended for most uses",
    "formatPngDesc": "Lossless quality, best for VFX and game dev",
    "estimatedOutput": "Estimated Output:",
    "estimatedImages": "IMAGES",
    "mobileSlowWarning": "{{count}} frames may be slow on mobile. Consider lowering FPS.",
    "readyTitle": "Ready to Extract?",
    "readyDesc": "Click below to process this video entirely in your browser. All frames will be extracted locally and combined into a single ZIP file download.",
    "extractFrames": "Extract Frames Now",
...
const es = {
  ...
  "controls": {
    ...
    "fpsSuffix": "Fotogramas Por Segundo",
    "formatJpgDesc": "Tamaño de archivo más pequeño, recomendado para la mayoría de los usos",
    "formatPngDesc": "Calidad sin pérdidas, mejor para VFX y desarrollo de juegos",
    "estimatedOutput": "Salida Estimada:",
    "estimatedImages": "IMÁGENES",
    "mobileSlowWarning": "{{count}} fotogramas pueden ser lentos en móviles. Considera reducir los FPS.",
    "readyTitle": "¿Listo para Extraer?",
    "readyDesc": "Haz clic abajo para procesar este video en tu navegador. Todos los fotogramas se extraerán localmente y se descargarán en un ZIP.",
    "extractFrames": "Extraer Fotogramas Ahora",
  ...
  "home": {
    ...
    "faq": {
      ...
      "sub": "Todo lo que necesitas saber sobre Video to Image Sequence Online",
      "items": [
        { "q": "¿Hay un límite de tamaño?", "a": "No se requiere subir al servidor. El procesamiento ocurre localmente en el navegador, por lo que depende de la RAM de tu dispositivo." },
        { "q": "¿Qué formatos de video son compatibles?", "a": "MP4, MOV y WEBM: los tres más comunes." },
        { "q": "¿Debo extraer fotogramas en JPG o PNG?", "a": "JPG se recomienda por el tamaño ligero. Elige PNG si necesitas máxima calidad sin pérdida o transparencias." },
        { "q": "¿Mis videos están seguros?", "a": "100% seguros. El procesamiento es puramente local; tus archivos nunca salen de tu ordenador." },
        { "q": "¿Puedo descargar todos los fotogramas a la vez?", "a": "Sí. Haz clic en 'Descargar Todo (ZIP)' para obtener un archivo único." },
        { "q": "¿Cómo controlo cuántos fotogramas se extraen?", "a": "Configura la velocidad de fotogramas (FPS) en el selector antes de hacer clic en Extraer." },
        { "q": "¿Puedo procesar varios videos a la vez?", "a": "Sí. Suelta múltiples archivos para habilitar el procesamiento por lotes." },
        { "q": "¿Puedo descargar fotogramas individuales?", "a": "Sí. Pasa el cursor sobre el fotograma y haz clic en el botón de descarga." },
        { "q": "¿Cuál es la mejor alternativa gratuita?", "a": "Nuestra herramienta es la mejor alternativa local, sin límites de servidor, 100% gratis y privada." },
        { "q": "¿Necesito instalar algo?", "a": "No, funciona directamente en cualquier navegador moderno sin registrarse ni instalar extensiones." }
      ]
    }
  },
  "mp4ToJpg": {
...
const languages = ['fr', 'de', 'pt', 'zh', 'ar', 'hi'];

// Use helper to deep-merge keys dynamically for all files
...
// 1. Write en.json and es.json directly
fs.writeFileSync(path.join(localesDir, 'en.json'), JSON.stringify(en, null, 2), 'utf-8');
...
// 2. Loop over other locales and perform deep merge
languages.forEach(lang => {
  ...
  // Deep-merge the English base structure first
  let merged = deepMerge(en, existing);

  // Apply basic language switcher labels and titles for custom languages
  if (lang === 'fr') {
    merged.nav = { "tools": "Outils", "blog": "Blog", "howItWorks": "Comment ça Marche", "faq": "FAQ", "language": "Langue" };
    merged.home.h1 = "Vidéo en Séquence d'Images";
    merged.home.h1Sub = "Convertisseur en Ligne";
    merged.home.badge = "100% Gratuit · Sans Envoi · Traitement Local";
    merged.home.tabs = { "toImages": "Vidéo en Images", "toVideo": "Images en Vidéo" };
    merged.home.faq.title = "Questions Fréquentes";
    merged.home.faq.sub = "Tout ce que vous devez savoir sur Video to Image Sequence Online";
  } else if (lang === 'de') {
    merged.nav = { "tools": "Werkzeuge", "blog": "Blog", "howItWorks": "Wie es Funktioniert", "faq": "Häufige Fragen", "language": "Sprache" };
    merged.home.h1 = "Video zu Bildsequenz";
    merged.home.h1Sub = "Online-Konverter";
    merged.home.badge = "100% Kostenlos · Kein Upload · Lokale Verarbeitung";
    merged.home.tabs = { "toImages": "Video zu Bildern", "toVideo": "Bilder zu Video" };
    merged.home.faq.title = "Häufig Gestellte Fragen";
    merged.home.faq.sub = "Alles, was Sie über Video to Image Sequence Online wissen müssen";
  } else if (lang === 'pt') {
    merged.nav = { "tools": "Ferramentas", "blog": "Blog", "howItWorks": "Como Funciona", "faq": "Perguntas Frequentes", "language": "Idioma" };
    merged.home.h1 = "Vídeo para Sequência de Imagens";
    merged.home.h1Sub = "Conversor Online";
    merged.home.badge = "100% Grátis · Sem Upload · Processamento Local";
    merged.home.tabs = { "toImages": "Vídeo para Imagens", "toVideo": "Imagens para Vídeo" };
    merged.home.faq.title = "Perguntas Frequentes";
    merged.home.faq.sub = "Tudo o que você precisa saber sobre o Video to Image Sequence Online";
  } else if (lang === 'zh') {
    merged.nav = { "tools": "工具", "blog": "博客", "howItWorks": "使用方法", "faq": "常见问题", "language": "语言" };
    merged.home.h1 = "视频转图像序列";
    merged.home.h1Sub = "在线转换器";
    merged.home.badge = "100% 免费 · 无需上传 · 本地处理";
    merged.home.tabs = { "toImages": "视频转图片", "toVideo": "图片转视频" };
    merged.home.faq.title = "常见问题";
    merged.home.faq.sub = "关于视频转图像序列在线转换器的所有常见问题";
  } else if (lang === 'ar') {
    merged.nav = { "tools": "الأدوات", "blog": "المدونة", "howItWorks": "كيف يعمل", "faq": "الأسئلة الشائعة", "language": "اللغة" };
    merged.home.h1 = "تحويل الفيديو إلى تسلسل صور";
    merged.home.h1Sub = "محول أونلاين";
    merged.home.badge = "مجاني 100% · بدون رفع · معالجة محلية";
    merged.home.tabs = { "toImages": "تحويل الفيديو إلى صور", "toVideo": "تحويل الصور إلى فيديو" };
    merged.home.faq.title = "الأسئلة الشائعة";
    merged.home.faq.sub = "كل ما تحتاج لمعرفته حول Video to Image Sequence Online";
  } else if (lang === 'hi') {
    merged.nav = { "tools": "उपकरण", "blog": "ब्लॉग", "howItWorks": "कैसे काम करता है", "faq": "अक्सर पूछे जाने वाले प्रश्न", "language": "भाषा" };
    merged.home.h1 = "वीडियो से इमेज सीक्वेंस";
    merged.home.h1Sub = "ऑनलाइन कनवर्टर";
    merged.home.badge = "100% मुफ़्त · कोई अपलोड नहीं · स्थानीय प्रसंस्करण";
    merged.home.tabs = { "toImages": "वीडियो से छवियां", "toVideo": "छवियों से वीडियो" };
    merged.home.faq.title = "अक्सर पूछे जाने वाले प्रश्न";
    merged.home.faq.sub = "वीडियो से इमेज सीक्वेंस ऑनलाइन कनवर्टर के बारे में सब कुछ";
  }

  // Save changes
  fs.writeFileSync(filePath, JSON.stringify(merged, null, 2), 'utf-8');
  console.log(`Successfully deep-merged and updated locales for: ${lang}`);
});
